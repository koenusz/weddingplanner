...
var _user$project$Routing$InvitationIndexRoute = {ctor: 'InvitationIndexRoute'};
var _user$project$Routing$InvitationRoute = function (a) {
	return {ctor: 'InvitationRoute', _0: a};
};
...
var _user$project$Routing$matchers = _evancz$url_parser$UrlParser$oneOf(
	{
		...
		_1: {
			...
			_0: A2(
				_evancz$url_parser$UrlParser$map,
				_user$project$Routing$InvitationRoute,
				A2(
					_evancz$url_parser$UrlParser_ops['</>'],
					_evancz$url_parser$UrlParser$s('invitations'),
					_evancz$url_parser$UrlParser$int)),
			_1: {
				ctor: '::',
				_0: A2(
					_evancz$url_parser$UrlParser$map,
					_user$project$Routing$InvitationIndexRoute,
					_evancz$url_parser$UrlParser$s('invitations')),
				_1: {ctor: '[]'}
			}
		}
...
var _user$project$Model$Model = F6(
	function (a, b, c, d, e, f) {
		return {invitations: a, invitation: b, error: c, search: d, route: e, popup: f};
	});
var _user$project$Model$InvitationList = F4(
	function (a, b, c, d) {
		return {entries: a, page_number: b, total_entries: c, total_pages: d};
	});
var _user$project$Model$Invitation = F8(
	function (a, b, c, d, e, f, g, h) {
		return {id: a, name: b, wedding: c, party: d, dinner: e, attending_wedding: f, attending_party: g, attending_dinner: h};
	});
var _user$project$Model$Dinner = {ctor: 'Dinner'};
var _user$project$Model$Party = {ctor: 'Party'};
var _user$project$Model$Wedding = {ctor: 'Wedding'};
...
var _user$project$Model$initialModel = function (route) {
	return {invitations: _user$project$Model$NotRequested, invitation: _user$project$Model$NotRequested, error: _elm_lang$core$Maybe$Nothing, search: '', route: route, popup: _elm_lang$core$Maybe$Nothing};
};
var _user$project$Model$Declined = {ctor: 'Declined'};
var _user$project$Model$Accepted = {ctor: 'Accepted'};
var _user$project$Model$Invited = {ctor: 'Invited'};
var _user$project$Model$NotInvited = {ctor: 'NotInvited'};
var _user$project$Model$initiaInvitation = {id: 0, name: '', wedding: _user$project$Model$NotInvited, party: _user$project$Model$NotInvited, dinner: _user$project$Model$NotInvited, attending_wedding: 0, attending_party: 0, attending_dinner: 0};
var _user$project$Model$toggleStatus = function (old) {
	var _p0 = old;
	switch (_p0.ctor) {
		case 'NotInvited':
			return _user$project$Model$NotInvited;
		case 'Invited':
			return _user$project$Model$Accepted;
		case 'Accepted':
			return _user$project$Model$Declined;
		default:
			return _user$project$Model$Accepted;
	}
};
var _user$project$Model$stringToStatus = function (string) {
	var _p1 = string;
	switch (_p1) {
		case 'NotInvited':
			return _user$project$Model$NotInvited;
		case 'Invited':
			return _user$project$Model$Invited;
		case 'Accepted':
			return _user$project$Model$Accepted;
		case 'Declined':
			return _user$project$Model$Declined;
...
var _user$project$Codec$encodeInvitation = function (invitation) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: 'id',
				_1: _elm_lang$core$Json_Encode$int(invitation.id)
			},
			_1: {
				ctor: '::',
				_0: {
					...
					_1: _elm_lang$core$Json_Encode$object(
						{
							...
							_0: {
								ctor: '_Tuple2',
								_0: 'name',
								_1: _elm_lang$core$Json_Encode$string(invitation.name)
							},
							_1: {
								ctor: '::',
								_0: {
									...
									_1: _elm_lang$core$Json_Encode$string(
										_elm_lang$core$Basics$toString(invitation.wedding))
								},
								_1: {
									ctor: '::',
									_0: {
										...
										_0: 'party',
										_1: _elm_lang$core$Json_Encode$string(
											_elm_lang$core$Basics$toString(invitation.party))
									},
									_1: {
										ctor: '::',
										_0: {
											...
											_0: 'dinner',
											_1: _elm_lang$core$Json_Encode$string(
												_elm_lang$core$Basics$toString(invitation.dinner))
										},
										_1: {
											ctor: '::',
											_0: {
												ctor: '_Tuple2',
												_0: 'attending_wedding',
												_1: _elm_lang$core$Json_Encode$int(invitation.attending_wedding)
											},
											_1: {
												ctor: '::',
												_0: {
													ctor: '_Tuple2',
													_0: 'attending_party',
													_1: _elm_lang$core$Json_Encode$int(invitation.attending_party)
												},
												_1: {
													ctor: '::',
													_0: {
														ctor: '_Tuple2',
														_0: 'attending_dinner',
														_1: _elm_lang$core$Json_Encode$int(invitation.attending_dinner)
													},
													_1: {ctor: '[]'}
												}
											}
...
var _user$project$Codec$invitationDecoder = A3(
	...
	A3(
		...
		A3(
			...
			A3(
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
				'dinner',
				A2(_elm_lang$core$Json_Decode$map, _user$project$Model$stringToStatus, _elm_lang$core$Json_Decode$string),
				A3(
					_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
					'party',
					A2(_elm_lang$core$Json_Decode$map, _user$project$Model$stringToStatus, _elm_lang$core$Json_Decode$string),
					A3(
						...
						A3(
							...
							A3(
								...
								'id',
								_elm_lang$core$Json_Decode$int,
								_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Model$Invitation)))))))));
var _user$project$Codec$invitationListDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'total_pages',
	_elm_lang$core$Json_Decode$int,
	A3(
		...
		A3(
			...
			A3(
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
				'entries',
				_elm_lang$core$Json_Decode$list(_user$project$Codec$invitationDecoder),
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Model$InvitationList)))));

var _user$project$Invitation_Messages$AttendingDinner = function (a) {
	return {ctor: 'AttendingDinner', _0: a};
};
var _user$project$Invitation_Messages$AttendingParty = function (a) {
	return {ctor: 'AttendingParty', _0: a};
};
var _user$project$Invitation_Messages$AttendingWedding = function (a) {
	return {ctor: 'AttendingWedding', _0: a};
};
var _user$project$Invitation_Messages$Dinner = function (a) {
	return {ctor: 'Dinner', _0: a};
};
var _user$project$Invitation_Messages$Party = function (a) {
	return {ctor: 'Party', _0: a};
};
var _user$project$Invitation_Messages$Wedding = function (a) {
	return {ctor: 'Wedding', _0: a};
};
var _user$project$Invitation_Messages$Name = function (a) {
	return {ctor: 'Name', _0: a};
};

var _user$project$Messages$ResetPopup = {ctor: 'ResetPopup'};
var _user$project$Messages$InvitationMsg = function (a) {
	return {ctor: 'InvitationMsg', _0: a};
};
var _user$project$Messages$HandleInvitationFormSubmit = function (a) {
	return {ctor: 'HandleInvitationFormSubmit', _0: a};
};
...
var _user$project$Messages$UpdateInvitation = function (a) {
	return {ctor: 'UpdateInvitation', _0: a};
};
var _user$project$Messages$FetchInvitation = function (a) {
	return {ctor: 'FetchInvitation', _0: a};
};
		...
		return _elm_lang$http$Http$request(
			{
				...
				url: url,
				body: body,
				expect: _elm_lang$http$Http$expectJson(_user$project$Codec$invitationDecoder),
				timeout: _elm_lang$core$Maybe$Nothing,
				withCredentials: false
			});
	});
var _user$project$Commands$updateInvitation = function (invitation) {
	var apiUrl = A2(
		_elm_lang$core$Basics_ops['++'],
		'/api/invitations/',
		_elm_lang$core$Basics$toString(invitation.id));
	var request = A2(
		_user$project$Commands$put,
		apiUrl,
		_elm_lang$http$Http$jsonBody(
			_user$project$Codec$encodeInvitation(invitation)));
	return A2(_elm_lang$http$Http$send, _user$project$Messages$UpdateInvitation, request);
};
var _user$project$Commands$getInvitation = function (id) {
	var apiUrl = A2(
		_elm_lang$core$Basics_ops['++'],
		'/api/invitations/',
		_elm_lang$core$Basics$toString(id));
	var request = A2(_elm_lang$http$Http$get, apiUrl, _user$project$Codec$invitationDecoder);
	return A2(_elm_lang$http$Http$send, _user$project$Messages$FetchInvitation, request);
};
var _user$project$Commands$indexInvitations = F2(
	function (pageNumber, search) {
		var apiUrl = A2(
			_elm_lang$core$Basics_ops['++'],
			'/api/invitations?page=',
			A2(
				_elm_lang$core$Basics_ops['++'],
				_elm_lang$core$Basics$toString(pageNumber),
				A2(_elm_lang$core$Basics_ops['++'], '&search=', search)));
		var request = A2(_elm_lang$http$Http$get, apiUrl, _user$project$Codec$invitationListDecoder);
		return A2(_elm_lang$http$Http$send, _user$project$Messages$FetchResult, request);
	});

var _user$project$Common_View$paginationLink = F2(
...
var _user$project$Common_View$paginationList = F2(
	function (totalPages, pageNumber) {
		return A2(
			...
			A2(
				_elm_lang$core$List$map,
				_user$project$Common_View$paginationLink(pageNumber),
				A2(_elm_lang$core$List$range, 1, totalPages)));
	});
var _user$project$Common_View$popup = function (message) {
	var _p0 = message;
	if (_p0.ctor === 'Just') {
		return A2(
...
var _user$project$Common_View$backToHomeLink = A2(
	_elm_lang$html$Html$a,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Events$onClick(
			_user$project$Messages$NavigateTo(_user$project$Routing$HomeRoute)),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
		_0: _elm_lang$html$Html$text('← Back to main page'),
		_1: {ctor: '[]'}
	});
...
var _user$project$Css_WPCss$css = function (_p0) {
	return _rtfeldman$elm_css$Css$stylesheet(
		A2(_rtfeldman$elm_css$Css_Namespace$namespace, 'weddingplanner', _p0));
}(
	{
		ctor: '::',
		_0: _rtfeldman$elm_css$Css_Elements$body(
			{
				ctor: '::',
				_0: _rtfeldman$elm_css$Css$overflowX(_rtfeldman$elm_css$Css$auto),
				_1: {
					ctor: '::',
					...
					_1: {
						...
						_0: _rtfeldman$elm_css$Css$height(
							_rtfeldman$elm_css$Css$vh(98)),
						_1: {
							ctor: '::',
							_0: _rtfeldman$elm_css$Css$fontFamilies(
								{
									ctor: '::',
									_0: _rtfeldman$elm_css$Css$qt('Josefin Slab'),
									_1: {
										ctor: '::',
										_0: function (_) {
											return _.value;
										}(_rtfeldman$elm_css$Css$serif),
										_1: {ctor: '[]'}
									}
								}),
							_1: {
		...
		_1: {
			...
			_1: {
				...
				_0: A2(
					...
					_user$project$Css_WPCss$NavBar,
					{
						ctor: '::',
						_0: _rtfeldman$elm_css$Css$margin(_rtfeldman$elm_css$Css$zero),
						_1: {
										...
										_0: _rtfeldman$elm_css$Css_Elements$li(
											{
												...
												_1: {
													ctor: '::',
													_0: _rtfeldman$elm_css$Css$color(_user$project$Css_WPCss$primaryAccentColor),
													_1: {ctor: '[]'}
												}
											}),
										_1: {ctor: '[]'}
...
var _user$project$Invitation_Update$update = F2(
	function (msg, model) {
		var _p0 = model.invitation;
		if (_p0.ctor === 'Success') {
			var _p2 = _p0._0;
			var _p1 = msg;
			switch (_p1.ctor) {
				case 'Name':
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								invitation: _user$project$Model$Success(
									_elm_lang$core$Native_Utils.update(
										_p2,
										{name: _p1._0}))
							}),
...
var _user$project$Invitation_View$selectIcon = function (status) {
	var _p0 = status;
	switch (_p0.ctor) {
		case 'NotInvited':
		...
		default:
			return 'fa fa-close fa-lg';
	}
};
var _user$project$Invitation_View$viewInvitation = function (invitation) {
	return A2(
		_elm_lang$html$Html$tr,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('invitation'),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onClick(
					_user$project$Messages$NavigateTo(
						_user$project$Routing$InvitationRoute(invitation.id))),
				_1: {ctor: '[]'}
			}
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(invitation.name),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$td,
					{
						...
						_0: _elm_lang$html$Html_Attributes$class(
							_user$project$Invitation_View$selectIcon(invitation.wedding)),
						_1: {ctor: '[]'}
					},
					{ctor: '[]'}),
				_1: {
					...
					_0: A2(
						_elm_lang$html$Html$td,
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class(
								_user$project$Invitation_View$selectIcon(invitation.party)),
							_1: {ctor: '[]'}
						},
						{ctor: '[]'}),
					_1: {
						...
						_0: A2(
							_elm_lang$html$Html$td,
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class(
									_user$project$Invitation_View$selectIcon(invitation.dinner)),
								_1: {ctor: '[]'}
							},
							{ctor: '[]'}),
						_1: {ctor: '[]'}
...
var _user$project$Invitation_View$viewList = function (list) {
	return A2(
			...
			_1: {
				...
				_1: {
					...
					_0: A2(
						...
						{ctor: '[]'},
						A2(_elm_lang$core$List$map, _user$project$Invitation_View$viewInvitation, list)),
					_1: {ctor: '[]'}
				}
			}
		});
};
var _user$project$Invitation_View$view = function (model) {
	var _p1 = model.invitations;
	switch (_p1.ctor) {
		case 'NotRequested':
			return _elm_lang$html$Html$text('');
		case 'Requesting':
			...
			return A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: A2(_user$project$Common_View$paginationList, _p2.total_pages, _p2.page_number),
							_1: {
								ctor: '::',
								_0: A2(
									_elm_lang$html$Html$div,
									...
									{
										ctor: '::',
										_0: _user$project$Invitation_View$viewList(_p2.entries),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
...
var _user$project$Invitation_ViewForm$invitationIcon = function (status) {
	var _p0 = status;
	switch (_p0.ctor) {
		case 'NotInvited':
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('fa fa-question-circle-o fa-lg'),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$style(
							{
		...
		case 'Accepted':
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('fa fa-check fa-lg'),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$style(
							{
		...
		default:
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('fa fa-close fa-lg'),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$style(
							{
...
var _user$project$Invitation_ViewForm$stringToInt = function (string) {
...
var _user$project$Invitation_ViewForm$updateInvitation = F2(
	function (event, value) {
		var intValue = _user$project$Invitation_ViewForm$stringToInt(value);
		var _p2 = event;
		switch (_p2.ctor) {
			case 'Wedding':
				return _user$project$Messages$InvitationMsg(
					_user$project$Invitation_Messages$AttendingWedding(intValue));
			case 'Party':
				return _user$project$Messages$InvitationMsg(
					_user$project$Invitation_Messages$AttendingParty(intValue));
			default:
				return _user$project$Messages$InvitationMsg(
					_user$project$Invitation_Messages$AttendingDinner(intValue));
		}
	});
var _user$project$Invitation_ViewForm$view = function (invitation) {
	return A2(
		_elm_lang$html$Html$table,
		{
			ctor: '::',
				...
				{ctor: '[]'},
				{
					...
					_0: _elm_lang$html$Html$text(
						A2(
							_elm_lang$core$Basics_ops['++'],
							'Welcome ',
							A2(_elm_lang$core$Basics_ops['++'], invitation.name, ' please let us know if you will be attending.'))),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
					...
					{ctor: '[]'},
					{
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Attending?'),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Number of Persons'),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: (!_elm_lang$core$Native_Utils.eq(invitation.wedding, _user$project$Model$NotInvited)) ? A2(
								_elm_lang$html$Html$tr,
								{ctor: '[]'},
								{
									ctor: '::',
									...
									_1: {
										...
										_0: A2(
											_elm_lang$html$Html$div,
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onClick(
													_user$project$Messages$InvitationMsg(
														_user$project$Invitation_Messages$Wedding(
															_user$project$Model$toggleStatus(invitation.wedding)))),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
															...
															_1: {
																...
																_1: {
																	...
																	_0: _elm_lang$html$Html_Attributes$value(
																		_elm_lang$core$Basics$toString(invitation.attending_wedding)),
																	_1: {
																		ctor: '::',
																		_0: _elm_lang$html$Html_Events$onInput(
																			_user$project$Invitation_ViewForm$updateInvitation(_user$project$Model$Wedding)),
																		_1: {ctor: '[]'}
																	}
																}
															}
							...
							_1: {
								ctor: '::',
								_0: (!_elm_lang$core$Native_Utils.eq(invitation.party, _user$project$Model$NotInvited)) ? A2(
									_elm_lang$html$Html$tr,
									{ctor: '[]'},
									{
										ctor: '::',
										...
										_1: {
											...
											_0: A2(
												_elm_lang$html$Html$div,
												{
													...
													_0: _elm_lang$html$Html_Events$onClick(
														_user$project$Messages$InvitationMsg(
															_user$project$Invitation_Messages$Party(
																_user$project$Model$toggleStatus(invitation.party)))),
													_1: {ctor: '[]'}
												},
												{
													ctor: '::',
															...
															_elm_lang$html$Html$input,
															{
																...
																_1: {
																	...
																	_1: {
																		ctor: '::',
																		_0: _elm_lang$html$Html_Attributes$value(
																			_elm_lang$core$Basics$toString(invitation.attending_party)),
																		_1: {
																			ctor: '::',
																			_0: _elm_lang$html$Html_Events$onInput(
																				_user$project$Invitation_ViewForm$updateInvitation(_user$project$Model$Party)),
																			_1: {ctor: '[]'}
																		}
																	}
																}
								...
								_1: {
									ctor: '::',
									_0: (!_elm_lang$core$Native_Utils.eq(invitation.dinner, _user$project$Model$NotInvited)) ? A2(
										_elm_lang$html$Html$tr,
										{ctor: '[]'},
										{
											ctor: '::',
											...
											_1: {
												...
												_0: A2(
													_elm_lang$html$Html$div,
													{
														...
														_0: _elm_lang$html$Html_Events$onClick(
															_user$project$Messages$InvitationMsg(
																_user$project$Invitation_Messages$Dinner(
																	_user$project$Model$toggleStatus(invitation.dinner)))),
														_1: {ctor: '[]'}
													},
													{
														ctor: '::',
														_0: _user$project$Invitation_ViewForm$invitationIcon(invitation.dinner),
														_1: {ctor: '[]'}
													}),
												_1: {
													ctor: '::',
																...
																_elm_lang$html$Html$input,
																{
																	...
																	_1: {
																		...
																		_1: {
																			ctor: '::',
																			_0: _elm_lang$html$Html_Attributes$value(
																				_elm_lang$core$Basics$toString(invitation.attending_dinner)),
																			_1: {
																				ctor: '::',
																				_0: _elm_lang$html$Html_Events$onInput(
																					_user$project$Invitation_ViewForm$updateInvitation(_user$project$Model$Dinner)),
																				_1: {ctor: '[]'}
																			}
																		}
																	}
							...
							{ctor: '[]'},
							{
								...
								_0: A2(
									_elm_lang$html$Html$button,
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(
											_user$project$Messages$HandleInvitationFormSubmit(invitation)),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
...
var _user$project$Invitation_ViewForm$viewInvitationForm = function (model) {
	var _p3 = model.invitation;
	switch (_p3.ctor) {
		case 'NotRequested':
			return _elm_lang$html$Html$text('');
		case 'Requesting':
		...
		default:
			return A2(
				...
				{
					ctor: '::',
					_0: _user$project$Invitation_ViewForm$view(_p3._0),
					_1: {ctor: '[]'}
				});
	}
};
	...
	switch (_p0.ctor) {
		...
		case 'InvitationRoute':
			return A2(
				...
				_elm_lang$core$Native_Utils.update(
					model,
					{invitation: _user$project$Model$Requesting}),
				{
					ctor: '::',
					_0: _user$project$Commands$getInvitation(_p0._0),
					_1: {ctor: '[]'}
				});
		case 'InvitationIndexRoute':
			return A2(
				_elm_lang$core$Platform_Cmd_ops['!'],
				_elm_lang$core$Native_Utils.update(
					model,
					{invitations: _user$project$Model$Requesting}),
				{
					ctor: '::',
					_0: A2(_user$project$Commands$indexInvitations, 1, ''),
					_1: {ctor: '[]'}
				});
		default:
			return A2(
		...
		switch (_p1.ctor) {
				...
				if (_p1._0.ctor === 'Ok') {
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								invitations: _user$project$Model$Success(_p1._0._0)
							}),
						{ctor: '[]'});
				} else {
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								invitations: _user$project$Model$Failure('Something went wrong...')
							}),
						{ctor: '[]'});
				}
			case 'Paginate':
				return A2(
					...
					{
						ctor: '::',
						_0: A2(_user$project$Commands$indexInvitations, _p1._0, ''),
						_1: {ctor: '[]'}
					});
			case 'UrlChange':
				...
				if (_p1._0.ctor === 'Ok') {
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								invitation: _user$project$Model$Success(_p1._0._0)
							}),
						{ctor: '[]'});
				} else {
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								invitation: _user$project$Model$Failure('Something went wrong...')
							}),
						{ctor: '[]'});
				}
				...
				if (_p1._0.ctor === 'Ok') {
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							...
							{
								invitation: _user$project$Model$Success(_p1._0._0),
								popup: _elm_lang$core$Maybe$Just('Saved sucesfully')
							}),
						{ctor: '[]'});
				} else {
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							...
							{
								invitation: _user$project$Model$Failure('Something went wrong...'),
								popup: _elm_lang$core$Maybe$Just('Something went wrong...')
							}),
						{ctor: '[]'});
				}
			...
			case 'HandleFormSubmit':
				return A2(
					...
					{
						ctor: '::',
						_0: A2(_user$project$Commands$indexInvitations, 1, model.search),
						_1: {ctor: '[]'}
					});
			case 'HandleInvitationFormSubmit':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
					...
					{
						ctor: '::',
						_0: _user$project$Commands$updateInvitation(_p1._0),
						_1: {
							ctor: '::',
							_0: A2(_andrewMacmurray$elm_delay$Delay$after, 5000, _user$project$Messages$ResetPopup),
							_1: {ctor: '[]'}
						}
					});
			case 'ResetPopup':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{popup: _elm_lang$core$Maybe$Nothing}),
					{ctor: '[]'});
			default:
				var _p2 = A2(_user$project$Invitation_Update$update, _p1._0, model);
				var invitationModel = _p2._0;
				var invitationCmd = _p2._1;
				return {
					ctor: '_Tuple2',
					_0: invitationModel,
					_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Messages$InvitationMsg, invitationCmd)
				};
		}
	});

var _user$project$Search_View$invitation = function (invitation) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		},
		{
			...
			_0: A2(
				...
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(
						A2(_elm_lang$core$Basics_ops['++'], 'Are you? ', invitation.name)),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		});
};
var _user$project$Search_View$listInvitations = function (model) {
	var _p0 = model.invitations;
	switch (_p0.ctor) {
		case 'NotRequested':
			return _elm_lang$html$Html$text('');
		case 'Requesting':
			...
			return A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: A2(_user$project$Common_View$paginationList, _p1.total_pages, _p1.page_number),
							_1: {
								ctor: '::',
								_0: A2(
									_elm_lang$html$Html$div,
									{ctor: '[]'},
									A2(_elm_lang$core$List$map, _user$project$Search_View$invitation, _p1.entries)),
								_1: {ctor: '[]'}
							}
						}),
					_1: {
...
var _user$project$Search_View$view = function (model) {
	return A2(
		...
		},
		{
									...
									_1: {
										...
										_0: A2(
											_elm_lang$html$Html$input,
											{
												...
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$placeholder('What is your name?...'),
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$style(
															{
			...
			_1: {
				ctor: '::',
				_0: _user$project$Search_View$listInvitations(model),
				_1: {ctor: '[]'}
			}
		});
};
...
var _user$project$View$page = function (model) {
	...
	switch (_p0.ctor) {
		case 'HomeRoute':
			return _user$project$Search_View$view(model);
		case 'InvitationRoute':
			return _user$project$Invitation_ViewForm$viewInvitationForm(model);
		case 'InvitationIndexRoute':
			return _user$project$Invitation_View$view(model);
		default:
			return _user$project$View$notFoundView;
	}
};
var _user$project$View$_p1 = _rtfeldman$elm_css_helpers$Html_CssHelpers$withNamespace('weddingplanner');
var _user$project$View$id = _user$project$View$_p1.id;
var _user$project$View$class = _user$project$View$_p1.$class;
var _user$project$View$classList = _user$project$View$_p1.classList;
var _user$project$View$indexView = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _user$project$View$id(_user$project$Css_WPCss$Page),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				_elm_lang$html$Html$header,
				{
					...
					_0: _elm_lang$html$Html_Attributes$hidden(
						_elm_lang$core$Native_Utils.eq(model.route, _user$project$Routing$HomeRoute)),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: _user$project$Common_View$popup(model.popup),
					_1: {ctor: '[]'}
				}
			}
		});
...
var _user$project$Main$main = A2(
	...
	_user$project$Messages$UrlChange,
	{
		...
		view: _user$project$View$indexView,
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"message":"Messages.Msg","aliases":{"Model.InvitationList":{"type":"{ entries : List Model.Invitation , page_number : Int , total_entries : Int , total_pages : Int }","args":[]},"Model.Invitation":{"type":"{ id : Int , name : String , wedding : Model.Status , party : Model.Status , dinner : Model.Status , attending_wedding : Int , attending_party : Int , attending_dinner : Int }","args":[]},"Navigation.Location":{"type":"{ href : String , host : String , hostname : String , protocol : String , origin : String , port_ : String , pathname : String , search : String , hash : String , username : String , password : String }","args":[]},"Http.Response":{"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }","args":["body"]}},"unions":{"Dict.NColor":{"tags":{"Black":[],"BBlack":[],"Red":[],"NBlack":[]},"args":[]},"Model.Status":{"tags":{"NotInvited":[],"Accepted":[],"Invited":[],"Declined":[]},"args":[]},"Result.Result":{"tags":{"Err":["error"],"Ok":["value"]},"args":["error","value"]},"Http.Error":{"tags":{"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"],"BadUrl":["String"],"NetworkError":[]},"args":[]},"Dict.LeafColor":{"tags":{"LBlack":[],"LBBlack":[]},"args":[]},"Messages.Msg":{"tags":{"NavigateTo":["Routing.Route"],"HandleSearchInput":["String"],"UrlChange":["Navigation.Location"],"UpdateInvitation":["Result.Result Http.Error Model.Invitation"],"HandleFormSubmit":[],"InvitationMsg":["Invitation.Messages.Msg"],"Paginate":["Int"],"HandleInvitationFormSubmit":["Model.Invitation"],"ResetPopup":[],"FetchResult":["Result.Result Http.Error Model.InvitationList"],"FetchInvitation":["Result.Result Http.Error Model.Invitation"]},"args":[]},"Invitation.Messages.Msg":{"tags":{"AttendingDinner":["Int"],"Name":["String"],"Dinner":["Model.Status"],"Party":["Model.Status"],"AttendingWedding":["Int"],"Wedding":["Model.Status"],"AttendingParty":["Int"]},"args":[]},"Routing.Route":{"tags":{"NotFoundRoute":[],"InvitationRoute":["Int"],"InvitationIndexRoute":[],"HomeRoute":[]},"args":[]},"Dict.Dict":{"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]},"args":["k","v"]}}},"versions":{"elm":"0.18.0"}});
}
